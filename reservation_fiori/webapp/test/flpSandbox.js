		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App fiori gestion reservation",
									"targetURL": "#nsreservationfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsreservationfiori-display": {
								"semanticObject": "nsreservationfiori",
								"action": "display",
								"description": "App fiori gestion reservation",
								"title": "App fiori gestion reservation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.reservationfiori",
									"url": sap.ui.require.toUrl("ns/reservationfiori")
								}
							}
						}
					}
