    ...
    return Object.extend("ns.reservationfiori.JobRepository", {
        ...
        constructor: function (oComponent) {
            this._repo = {
                ...
                "Z_ARTICLES": this.getListArticles.bind(this),
                "Z_SEARCH_HELP": this.getSearchHelp.bind(this)
        ...
        getListArticles: function (oConfig) {
            var that = this;

            this.oDataV2Model.read("/ArticleSet", {
                method: "GET",
        ...
        getSearchHelp: function (oConfig) {
            var that = this;
            var sFilter = "Fieldname eq'" + oConfig.fieldname + "'";
            this.oDataV2Model.read("/SearchHelpSet", {
                urlParameters: {
                    "$filter": sFilter
                },
                method: "GET",
